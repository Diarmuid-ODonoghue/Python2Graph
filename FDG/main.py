...
convert_to_csv = False  # convert the full file into one csv file
draw_methods = False  # if you want to draw the individual methods
convert_method_to_csv = True  # convert only mehtods to csv's
print_tree = True  # if you want to print the tree to the console

"""where the python code is located"""
#basePath = "F:/newSelection/"
#basePath = "F:/randomSelection/"
#basePath = "ObfusacatorCode/"
#basePath = "srcCode/"
##basePath = "F:/pycorpus/"
# basePath = "F:/Tester/"
basePath = os.path.dirname(os.path.realpath(__file__,)).replace('\\', '/') + '/'
""" where you want the csv's to be saved"""
csvLocation = basePath + "dfs3/"  # where you want the csv's to be saved
pyLocation = basePath + "python-corpus"  # where the corpus of python files is located
newLocation = basePath + "pyCorpus/"  # where you want the corpus of python file to be copied to
...
#get_results()
#getPyFiles(pyLocation, newLocation) # to bring all python files in a directory to the top and than move them to a new location
